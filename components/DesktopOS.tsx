...
import IDEInterface from './Membrane IDE/IDEInterface';
import EmailCaptureOverlay from './EmailCaptureOverlay';
import MembraneConsole from './Membrane Console/MembraneConsole';
            ...
            return (
              ...
              >
                <div className="window-drag-handle h-10 bg-[#252526] border-b border-[#3E3E42] flex items-center px-4 cursor-move">
                  ...
                  <div className="flex-1 text-center text-gray-300 text-sm font-medium flex items-center justify-center gap-2">
                    <svg
                      className="w-4 h-5"
                      viewBox="0 0 180 225"
                      fill="none"
