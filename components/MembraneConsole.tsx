                    ...
                    <div className="mt-3 space-y-1.5">
                      {companyAnalysis.suggestedUseCases.slice(0, 3).map((useCase, index) => (
                        <button
                          ...
                          className="w-full px-3 py-2 bg-white border border-gray-200 rounded-md text-left text-gray-600 text-xs hover:border-gray-400 hover:bg-gray-50 transition-all flex items-center gap-2 group"
                        >
                          <svg
